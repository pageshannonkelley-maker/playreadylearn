...
Keep your tone warm, short, and friendly. Steps should be very brief — one sentence each. Moms are busy and may need to come back to this later, so make it easy to pick up where they left off.`;
  ...
  const getQuote = (count) => {
    const quotes = [
      ...
      { text: "Intelligence is not a single, fixed ability. It is a collection of many different kinds of thinking.", author: "Howard Gardner" },
              ...
              if (msg.role === "quote") {
                return (
                  <div key={i} style={{
                    ...
                    "{msg.content.text}"
                    <div style={{ marginTop: "6px", fontSize: "12px", fontStyle: "normal", fontWeight: "bold" }}>
                      — {msg.content.author}
                    </div>
                  </div>
                );
